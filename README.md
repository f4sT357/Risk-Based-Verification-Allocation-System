...
4. **Robustness & Resilience**: A key feature is the built-in mechanism for **Sensitivity Analysis**. The system tests how its chosen "best" decision holds up if underlying assumptions (like probability multipliers) are slightly incorrect, forcing consideration of robustness over mere theoretical optimality.
